...
import MapView from '../../components/WebMap';
...
const OnlineLoadCard = ({
  ...
  return (
    <View style={[styles.onlineLoadCard, isWeb && showActions ? styles.onlineLoadCardExpanded : null]}>
      ...
      {showActions ? (
        isWeb ? (
          <View style={styles.onlineActionsWeb}>
            {applied ? (
              <TouchableOpacity
                style={[styles.cancel, styles.webActionButton]}
                onPress={() => onCancel(load.id)}>
                <Text style={styles.acceptText}>Cancel</Text>
              </TouchableOpacity>
            ) : (
              <>
                <TouchableOpacity style={[styles.acceptButton, styles.webActionButton]} onPress={onAccept}>
                  <Text style={styles.acceptText}>Apply</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.denyButton, styles.webActionButton]} onPress={onDeny}>
